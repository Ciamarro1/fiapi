...
## Initial Request — 2026-06-27T07:37:19Z

# Teamwork Project Prompt — Draft

Build FIAPI, a Cloudflare Workers AI-based "OpenAI-like" Image API, featuring an embedded Agent Governance Council (CIA and CTO agents) using @ag-kit/agents to automatically debate and design the system's cognitive and technical architecture before API execution.
