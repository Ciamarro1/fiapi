...
**Regra de Ouro:** O workflow não termina até que a task list esteja vazia, o código esteja provado por execução, o push remoto tenha sido concluído com sucesso e a memória institucional esteja gravada. Nenhuma pergunta trivial deve ser feita ao usuário durante a moagem.
